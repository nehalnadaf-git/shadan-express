...
export const metadata: Metadata = {
  title: "FAQ | Shadan's Biryani Express Hubli",
  description: "Frequently asked questions about Shadan's Biryani Express — location, hours, menu, delivery, bulk orders and more.",
  alternates: { canonical: 'https://biryaniexpresshubli.in/faq' },
}
    ...
    <div style={{ paddingTop: '72px' }}>
      ...
      <section style={{ background: 'var(--color-navy)', padding: 'clamp(56px,7vw,100px) clamp(24px,5vw,80px)', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '17px', color: 'var(--color-ivory-muted)', marginTop: '16px', maxWidth: '480px', margin: '16px auto 0', lineHeight: 1.7 }}>
          Everything you need to know before your visit to Shadan's Biryani Express
        </p>
      </section>
